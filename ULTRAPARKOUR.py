...
# PyInstaller ile .exe'ye çevrilince dosyalar sys._MEIPASS altındaki geçici bir klasöre açılır;
# normal .py çalıştırmada ise script'in kendi klasörü kullanılır.
try:
...
def mp_futbol_dongusu(conn, is_host):
    ...
    while True:
        ...
        if kazandi is not None:
            ...
            ekran.blit(ipucu2, (EN // 2 - ipucu2.get_width() // 2, 300))
